...
#' @param index_annotation_always_first_base `logical`. Whether to force the first base in each line to always be annotated regardless of whether it occurs at the `index_annotation_interval`. Defaults to `TRUE`.
#' @param index_annotation_always_last_base `logical`. Whether to force the last base in each line to always be annotated regardless of whether it occurs at the `index_annotation_interval`. Defaults to `TRUE`.
...
visualise_methylation <- function(
    ...
    bool <- list(return = return, index_annotations_above = index_annotations_above, index_annotation_full_line = index_annotation_full_line, index_annotation_always_first_base = index_annotation_always_first_base, index_annotation_always_last_base = index_annotation_always_last_base, force_raster = force_raster)
