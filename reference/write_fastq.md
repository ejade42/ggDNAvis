...
- dataframe:
  ...
  back to modified FASTQ. Must have columns for unique read ID and DNA
  sequence. Should also have a column for quality, unless wanting to
  fill in qualities with `"B"`.
