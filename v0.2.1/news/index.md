...
- Interactive web-app now available
  ...
  - Can be launched locally via
    [`ggDNAvis_shinyapp()`](https://ejade42.github.io/ggDNAvis/reference/ggDNAvis_shinyapp.html).
...
- Aliases: American spellings should now be available for all major
  ...
  - Every instance of `visualise` should now also work with `visualize`
    e.g. [`visualize_single_sequence()`](https://ejade42.github.io/ggDNAvis/reference/visualise_single_sequence.html).
  ...
  - There is a minor exception in that
    ...
    accepts
    [`visualize_methylation_color_scale()`](https://ejade42.github.io/ggDNAvis/reference/visualise_methylation_colour_scale.html)
...
- [`visualise_methylation()`](https://ejade42.github.io/ggDNAvis/reference/visualise_methylation.md)
  ...
  - As a consequence,
    ...
    and
    [`extract_and_sort_methylation()`](https://ejade42.github.io/ggDNAvis/reference/extract_and_sort_methylation.html)
...
- [`read_fastq()`](https://ejade42.github.io/ggDNAvis/reference/read_fastq.md)
  ...
  new helper
  [`strip_leading_at()`](https://ejade42.github.io/ggDNAvis/reference/strip_leading_at.html).
  This prevents issues when FASTQ read IDs start with @ but metadata
  read IDs do not, and IDs therefore cannot be merged.

- Massively improved
  [`rasterise_matrix()`](https://ejade42.github.io/ggDNAvis/reference/rasterise_matrix.html)
...
- Starting changing all argument validation to use
  [`bad_arg()`](https://ejade42.github.io/ggDNAvis/reference/bad_arg.html).
...
- [`resolve_alias()`](https://ejade42.github.io/ggDNAvis/reference/resolve_alias.html) -
  resolves value of an argument where aliases are used.

- [`resolve_alias_map()`](https://ejade42.github.io/ggDNAvis/reference/resolve_alias_map.html) -
  processes a list of many potential aliases for various arguments of a
  function, using
  [`resolve_alias()`](https://ejade42.github.io/ggDNAvis/reference/resolve_alias.html)
  for each individually.

- [`monitor_start()`](https://ejade42.github.io/ggDNAvis/reference/monitor_start.html) -
  initiate performance monitoring.

- [`monitor()`](https://ejade42.github.io/ggDNAvis/reference/monitor.html) -
  continue performance monitoring.

- [`format_time_diff()`](https://ejade42.github.io/ggDNAvis/reference/format_time_diff.html) -
  format a difference between times.

- [`convert_sequences_to_matrix()`](https://ejade42.github.io/ggDNAvis/reference/convert_sequences_to_matrix.html) -
  convert vector of sequences to character matrix.

- [`insert_at_indices()`](https://ejade42.github.io/ggDNAvis/reference/insert_at_indices.html) -
  inserts blank lines for index annotations.

- [`rasterise_index_annotations()`](https://ejade42.github.io/ggDNAvis/reference/rasterise_index_annotations.html) -
  calculates coordinates and labels for index annotations.

- [`rasterise_probabilities()`](https://ejade42.github.io/ggDNAvis/reference/rasterise_probabilities.html) -
