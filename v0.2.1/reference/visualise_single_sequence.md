...
- index_annotation_size:
  ...
  Can sometimes be set to `0` to turn off annotations, but it is
  better/more reliable to do this via `index_annotation_interval = 0`.
...
- index_annotation_interval:
  ...
  Set to `0` to turn off annotations (preferable over using
