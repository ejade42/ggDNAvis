...
test_that("argument validation rejects bad arguments for converting modification to number vector", {
    ...
    for (param in bad_param_value_for_modification) {
        expect_error(convert_modification_to_number_vector(modification_locations_str = param, modification_probabilities_str = "3,6,9", max_length = 20))
        expect_error(convert_modification_to_number_vector(modification_locations_str = "3,6,9", modification_probabilities_str = param, max_length = 20))
        expect_error(create_plot_masks(modification_locations_str = param, modification_probabilities_str = "3,6,9", max_length = 20, sequence_length = 15))
        expect_error(create_plot_masks(modification_locations_str = "3,6,9", modification_probabilities_str = param, max_length = 20, sequence_length = 15))
    }

    bad_param_value_for_modification_warn <- list("3. 6. 9", "x")
    for (param in bad_param_value_for_modification_warn) {
        expect_warning(expect_error(convert_modification_to_number_vector(modification_locations_str = param, modification_probabilities_str = "3,6,9", max_length = 20)))
        expect_warning(expect_error(convert_modification_to_number_vector(modification_locations_str = "3,6,9", modification_probabilities_str = param, max_length = 20)))
        expect_warning(expect_error(create_plot_masks(modification_locations_str = param, modification_probabilities_str = "3,6,9", max_length = 20, sequence_length = 15)))
        expect_warning(expect_error(create_plot_masks(modification_locations_str = "3,6,9", modification_probabilities_str = param, max_length = 20, sequence_length = 15)))
    }
    ...
    for (param in bad_param_value_for_non_negative_int) {
        expect_error(convert_modification_to_number_vector(modification_locations = "3,6,9", modification_probabilities = "3,6,9", max_length = param))
        expect_error(create_plot_masks(modification_locations = "3,6,9", modification_probabilities = "3,6,9", max_length = param, sequence_length = 15))
        expect_error(create_plot_masks(modification_locations = "3,6,9", modification_probabilities = "3,6,9", max_length = 15, sequence_length = param))
    }
})
