...
#> Error in bad_arg("number", positive_args, "must be positive") : 
#>   Argument 'number' must be positive
#> Current value: -1
...
#> Error in bad_arg("x", named, "is not acceptable") : 
#>   Argument 'x' is not acceptable
#> Current value: 1, 7
...
#> Error in bad_arg("number", positive_args, "must be positive", force_names = TRUE) : 
#>   Argument 'number' must be positive
#> Current value: -1
#> Current names: 
```
